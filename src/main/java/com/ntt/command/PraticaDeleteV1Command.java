...
@Component
@Scope("prototype")
public class PraticaDeleteV1Command extends BaseCommand<Payload> {

	@Autowired
	private Msad0EventsService service;

	@Autowired
	private PraticaDeleteV1Converter converter;

	private final Payload payload;

	public PraticaDeleteV1Command(Payload payload) {
	...
	public Payload doExecute() throws Exception {
		...
		Payload payloadResponse = this.service.praticaDeleteV1(payload);
