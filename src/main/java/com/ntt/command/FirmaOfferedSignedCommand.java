...
import com.ntt.converter.FirmaOfferedSignedConverter;
...
@Component
@Scope("prototype")
public class FirmaOfferedSignedCommand extends BaseCommand<Payload> {

	@Autowired
	private Msad0EventsService service;

	@Autowired
	private FirmaOfferedSignedConverter converter;

	private final Payload payload;

	public FirmaOfferedSignedCommand(Payload payload) {
	...
	public Payload doExecute() throws Exception {
		...
		Payload payloadResponse = this.service.firmaOfferSigned(payload);
