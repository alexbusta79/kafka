...
@Component
@Scope("prototype")
public class PraticaCancelV1Command extends BaseCommand<Payload> {

	@Autowired
	private Msad0EventsService service;

	@Autowired
	private PraticaCancelV1Converter converter;

	private final Payload payload;

	public PraticaCancelV1Command(Payload payload) {
	...
	public Payload doExecute() throws Exception {
		...
		Payload payloadResponse = this.service.praticaCancelV1(payload);
