...
@Component
@Scope("prototype")
public class DocumentaleDeletedV1Command extends BaseCommand<Payload> {

	@Autowired
	private Msad0EventsService service;

	@Autowired
	private DocumentaleDeletedV1Converter converter;

	private final Payload payload;

	public DocumentaleDeletedV1Command(Payload payload) {
	...
	public Payload doExecute() throws Exception {
		...
		Payload payloadResponse = this.service.documentaleDeletedV1(payload);
