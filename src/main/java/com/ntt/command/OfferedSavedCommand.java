...
import com.ntt.converter.OfferedSavedConverter;
...
@Component
@Scope("prototype")
public class OfferedSavedCommand extends BaseCommand<Payload> {

	@Autowired
	private Msad0EventsService service;

	@Autowired
	private OfferedSavedConverter converter;

	private final Payload payload;

	public OfferedSavedCommand(Payload payload) {
	...
	public Payload doExecute() throws Exception {
		...
		Payload payloadResponse = this.service.documentaleOfferSaved(payload);
