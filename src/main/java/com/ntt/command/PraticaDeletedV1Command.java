...
@Component
@Scope("prototype")
public class PraticaDeletedV1Command extends BaseCommand<Payload> {

	@Autowired
	private Msad0EventsService service;

	@Autowired
	private PraticaDeletedV1Converter converter;

	private final Payload payload;

	public PraticaDeletedV1Command(Payload payload) {
	...
	public Payload doExecute() throws Exception {
		...
		Payload payloadResponse = this.service.praticaDeletedV1(payload);
