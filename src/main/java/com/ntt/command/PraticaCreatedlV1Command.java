...
@Component
@Scope("prototype")
public class PraticaCreatedlV1Command extends BaseCommand<Payload> {
	...
	public PraticaCreatedlV1Command(Payload payload) {
	...
	public Payload doExecute() throws Exception {
		...
		Payload payloadResponse = this.service.praticaCreatedlV1(payload);
