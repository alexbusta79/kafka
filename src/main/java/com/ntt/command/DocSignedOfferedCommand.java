...
import com.ntt.converter.DocSignedOfferedConverter;
...
@Component
@Scope("prototype")
public class DocSignedOfferedCommand extends BaseCommand<Payload> {

	@Autowired
	private Msad0EventsService service;

	@Autowired
	private DocSignedOfferedConverter converter;

	private final Payload payload;

	public DocSignedOfferedCommand(Payload payload) {
	...
	public Payload doExecute() throws Exception {
		...
		Payload payloadResponse = this.service.docSignedOffered(payload);
