...
@Component
@Scope("prototype")
public class PraticaRetrievedV1Command extends BaseCommand<Payload> {

	@Autowired
	private Msad0EventsService service;

	@Autowired
	private PraticaRetrievedV1Converter converter;

	private final Payload payload;

	public PraticaRetrievedV1Command(Payload payload) {
	...
	public Payload doExecute() throws Exception {
		...
		Payload payloadResponse = this.service.praticaRetrievedV1(payload);
